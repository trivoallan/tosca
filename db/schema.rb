...
ActiveRecord::Schema.define(:version => 55) do
  ...
  create_table "beneficiaires", :force => true do |t|
    ...
    t.column "domaine",              :text,    :default => "",   :null => false
  end
  ...
  create_table "old_reversements", :force => true do |t|
    t.column "created_on",         :timestamp,                   :null => false
  ...
  add_index "old_reversements", ["correctif_id"], :name => "reversements_correctif_id_index"
  add_index "old_reversements", ["interaction_id"], :name => "reversements_interaction_id_index"
