...
# This generator is greatly inspired from the one of Radiant.
# Thanks to them for this great feature.
module Tosca
...
Rails::Generator::Commands::Base.class_eval { include Tosca::GeneratorBaseExtension }
